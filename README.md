...
```shell
wget -N https://raw.githubusercontent.com/jgddned/ayliop/main/vmess.sh && chmod +x ./vmess.sh
```

### vless

```shell
wget -N https://raw.githubusercontent.com/jgddned/ayliop/main/vless.sh && chmod +x ./vless.sh
```

### trojan

```shell
wget -N https://raw.githubusercontent.com/jgddned/ayliop/main/trojan.sh && chmod +x ./trojan.sh
```
